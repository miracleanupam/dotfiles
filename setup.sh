...
link_file "$DOTFILES_DIR/.vim/after/ftplugin/ruby.vim"              "$HOME/.vim/after/ftplugin/ruby.vim"
link_file "$DOTFILES_DIR/.vim/after/ftplugin/python.vim"            "$HOME/.vim/after/ftplugin/python.vim"
link_file "$DOTFILES_DIR/.vim/after/ftplugin/javascript.vim"        "$HOME/.vim/after/ftplugin/javascript.vim"
link_file "$DOTFILES_DIR/.vim/after/ftplugin/javascriptreact.vim"   "$HOME/.vim/after/ftplugin/javascriptreact.vim"
link_file "$DOTFILES_DIR/.vim/after/ftplugin/typescript.vim"        "$HOME/.vim/after/ftplugin/typescript.vim"
link_file "$DOTFILES_DIR/.vim/after/ftplugin/typescriptreact.vim"   "$HOME/.vim/after/ftplugin/typescriptreact.vim"
